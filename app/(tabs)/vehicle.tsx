...
export default function VehicleScreen() {
  ...
  const renderTripCard = ({ item }: { item: Trip }) => (
    <Card mode="outlined" style={styles.tripCard}>
      <Card.Content>
...
const styles = StyleSheet.create({
  ...
  vehicleText: { flex: 1 },
  vehicleName: { fontWeight: '600', color: '#212121' },
  vehicleReg: { color: '#757575' },
  odometerInfo: { alignItems: 'flex-end' },
  odometerLabel: { color: '#9E9E9E' },
  odometerValue: { color: '#9C27B0', fontWeight: 'bold' },
  ...
  odometerText: { color: '#9E9E9E' },
  distanceText: {
    color: '#9C27B0',
    fontWeight: 'bold',
    marginLeft: 'auto',
  },
  purposeText: { color: '#757575', marginTop: 4 },
  ...
  distanceLabel: { color: '#757575' },
  distanceValue: { color: '#9C27B0', fontWeight: 'bold' },
